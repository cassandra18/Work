...
const slides = [
    ...
    { id: 3, image: '/images/students-with-instruments2.jpeg', title: 'Cubs and Societies', description: 'We have a variety of clubs and societies that students can join', link: '/clubs' },
            ...
            >
                {slides.map((slide, index) => (
                    <SwiperSlide key={slide.id} className="relative">
                        <img src={slide.image} alt={slide.title} className="w-full h-full bg-cover" />
                        <div className="absolute inset-0 flex flex-col justify-center items-start pl-8 md:pl-20 lg:pl-48 text-white">
                            ...
                            {index === activeIndex && (
                                <>
                                    <motion.h1 
                                        className="text-3xl md:text-4xl lg:text-5xl font-bold text-blue-400"
                                    ...
                                    <motion.p 
                                        className="text-sm md:text-base bg-[rgba(0,0,0,0.4)] px-4 py-2 rounded-md mt-4"
                                        initial={{ opacity: 0, y: 50 }}
                                        animate={{ opacity: 1, y: 0 }}
                                        exit={{ opacity: 0, y: 50 }} 
