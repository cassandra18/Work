...
const slides = [
    { id: 1, image: '/images/school-image.jpeg', title: 'CBC-KERICHO', description: 'We are a school that is committed to providing quality education to our students', link: '/about/profile' },
