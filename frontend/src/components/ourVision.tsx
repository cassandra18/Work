...
import { Lightbulb, Users, Globe, Star, HeartHandshake, ShieldCheck, BookOpenCheck } from 'lucide-react';
...
const OurVision: React.FC = () => {
    ...
    const values = [
        ...
        {
            icon: <HeartHandshake className="mx-auto mb-2 text-green-600" size={32} />,
    ...
    return (
        ...
        <div className="relative bg-gradient-to-br from-green-50 to-white py-12 px-6 md:px-16 rounded-xl shadow-md max-w-6xl mx-auto font-sans poppins-regular ">
            ...
            <motion.p className="md:text-xl text-center mb-10 text-green-700" {...fadeIn(0.1)}>
                <strong>CBC Kericho Primary School & Junior Secondary</strong>
            </motion.p>

            <motion.p className="md:text-lg mb-6 text-gray-700 leading-relaxed" {...fadeIn(0.2)}>
                At <strong>CBC Kericho</strong>, we dream of a school where learning is fun, meaningful, and future-ready. A place where learners shine in their own unique ways, guided by caring mentors, and powered by curiosity and creativity.
            </motion.p>

            <motion.p className="md:text-lg mb-10 text-gray-700 leading-relaxed" {...fadeIn(0.3)}>
                We strive to be a <strong>center of excellence</strong> in Competency-Based Education — building the skills, values, and attitudes our learners need to succeed in school and beyond!
            </motion.p>
      ...
      >
        {item.icon} <strong>{item.title}</strong> {item.desc}
            ...
            <motion.div className="mb-14" {...fadeIn(0.5)}>
                <h2 className="text-3xl md:text-4xl font-bold mb-6 text-green-800 text-center">
                    🎯 Our Mission
                </h2>
                <p className="md:text-lg text-gray-700 text-center max-w-3xl mx-auto leading-relaxed">
                    To nurture confident, creative, and competent learners through a dynamic Competency-Based Curriculum — guided by values, driven by curiosity, and empowered to shape a better tomorrow.
                </p>
            </motion.div>

            {/* Core Values */}
  <motion.div className="mb-10" ref={ref} animate={isInView ? "animate" : "initial"} initial="initial" variants={fadeIn(0.6)}>
                <h2 className=" text-3xl md:text-4xl font-bold mb-6 text-green-800 text-center">
                    💚 Our Core Values
                </h2>
