...
const Footer: React.FC = () => {
  return (
    <footer className="bg-cover bg-center relative text-white poppins-regular" style={{ backgroundImage: `url('/images/footer-bg.jpeg')` }}>
      {/* Overlay */}
      ...
      <div className="flex items-start justify-center lg:justify-start gap-20 px-4 max-w-7xl mx-auto">
        ...
        <div className="w-full max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 text-center relative my-6">
          ...
          <div className="flex items-start flex-col ml-2 md:mx-0   text-sm md:text-base">
            <h3 className="text-[#9dffd3] font-bold text-lg mb-3 underline underline-offset-4">Contact Information</h3>
          ...
          {/* Quick Links */}
            ...
            <ul className="space-y-2">
              <li><Link to='/about/news' className="flex items-center hover:text-[#9dffd3]"> <FaNewspaper className="mr-3"/>News</Link></li>
              <li><Link to='/about/events' className="flex items-center hover:text-[#9dffd3]"><FaNewspaper className="mr-3"/>Events</Link></li>
            ...
            {/* Information links */}
            <div className="flex items-start flex-col ml-2 md:mx-0  text-sm md:text-base">
            <h3 className="text-[#9dffd3] font-bold text-lg mb-3 underline-offset-4 underline">Information For :</h3>
            <ul className="space-y-2">
              <li><Link to='/admission/overview' className="flex items-center hover:text-[#9dffd3]"> <MdOutlineAddReaction className="mr-3"/>Admission Overview</Link></li>
              <li><Link to='/about/administration' className="flex items-center hover:text-[#9dffd3]"><FaSchoolFlag className="mr-3"/>School Administration</Link></li>
              <li><Link to="/about/profile" className=" flex items-center hover:text-[#9dffd3]"><FaRegAddressCard className="mr-3"/>About CKC Kericho</Link></li>
              <li><Link to="/about/departments" className="flex items-center hover:text-[#9dffd3]"><FaBuildingUser className="mr-3"/>Departments</Link></li>
              <li><Link to="/gallery" className="flex items-center hover:text-[#9dffd3]"><GrGallery className="mr-3"/>Gallery</Link></li>
            </ul>
            </div>
        </div>
      </div>
